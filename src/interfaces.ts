...
// интерфейсы поддерживают наследоваине (extends)
// интерфейс можно наследовать от класса не содержащего приватных полей
// Псевдонимы типов не поддерживают наследования.
// TypeScript поддерживает кортежи. Кортеж — упорядоченный набор фиксированной длины.
...
// Т.е. interface можно доопределить (декларативное слияние), type alias нельзя
